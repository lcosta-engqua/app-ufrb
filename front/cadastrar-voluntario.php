      ...
      <div class="card card-pcd p-4">
        <div class="card-body">
          <div class="text-center mb-4">
            ...
            <p class="text-muted small"><strong>Cadastro do Voluntário</strong></p>
          </div>
          <form id="cadPcd" action="home.php"  method="post" novalidate>
            <div class="row g-3">
              ...
              <div class="col-12 col-md-6">
                ...
                <select class="form-select" id="tipoCarro" name="tipoCarro" required>
                  <option value="" selected disabled>Selecione o tipo de carro</option>
                  <option value="fisica">SUV</option>
                  <option value="intelectual">Sedan</option>
                  <option value="visual">Monovolume</option>
                  <option value="auditiva">Perua</option>
                  <option value="nao-se-aplica">Não se aplica</option>
                </select>
                <div class="invalid-feedback">Por favor, selecione o tipo do carro.</div>
              </div>
